...
public class MessageBox : ModalBox
{
    ...
    /// </summary>
    /// <remarks>
    ///     You can hook into your existing localization system here to lookup and return a translated string using the
    ///     original as a key.
    ...
    public static MessageBox Show(string message, string title = null, Action<DialogResult> onFinished = null,
        MessageBoxButtons buttons = MessageBoxButtons.OK)
    {
        var box = Instantiate(Resources.Load<GameObject>(PrefabResourceName)).GetComponent<MessageBox>();
    ...
    private void SetUpButtons(MessageBoxButtons buttons)
    {
        ...
        switch (buttons)
        {
            ...
            case MessageBoxButtons.OKCancel:
                ...
                CreateButton(button, Localize("Anuluj"), () =>
                {
            ...
            case MessageBoxButtons.YesNo:
                button.GetComponentInChildren<Text>().text = Localize("Tak");
                button.GetComponent<Button>().onClick.AddListener(() =>
                {
                ...
                CreateButton(button, Localize("Nie"), () =>
                {
            ...
            case MessageBoxButtons.RetryCancel:
                button.GetComponentInChildren<Text>().text = Localize("Ponów");
                button.GetComponent<Button>().onClick.AddListener(() =>
                {
            ...
            case MessageBoxButtons.AbortRetryIgnore:
                button.GetComponentInChildren<Text>().text = Localize("Przerwij");
                button.GetComponent<Button>().onClick.AddListener(() =>
                {
                ...
                CreateButton(button, Localize("Ponów"), () =>
                {
                    result = DialogResult.Retry;
                    Close();
                });
                CreateButton(button, Localize("Ignoruj"), () =>
                {
