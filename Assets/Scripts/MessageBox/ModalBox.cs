...
public abstract class ModalBox : MonoBehaviour
{
    ...
    /// <summary>
    ///     The RectTransform of the panel that contains the frame of the dialog window. This is needed so that it can be
    ///     centered correctly after it's size is adjusted to the dialogs contents.
    /// </summary>
    [Tooltip(
        ...
        if (!isSetup)
        {
            ...
            if (Title != null)
            {
                ...
                layoutElement.minHeight =
                    stringHeight(Title
                        .text); // Set the min height to the preferred height so that the parent dialog box vertical layout can resize correctly.
            }
            ...
            if (Message != null)
            {
                ...
                layoutElement.minHeight =
                    Message.preferredHeight; // Set the min height to the preferred height so that the parent dialog box vertical layout can resize correctly.
